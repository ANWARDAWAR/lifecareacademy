    ...
    <section>
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6">
        ...
        <p
          id="courses-empty"
          className={`${
            filteredCourses.length > 0 ? "hidden" : ""
          } mt-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-700 dark:border-amber-900/40 dark:bg-amber-900/20 dark:text-amber-200`}
        >
